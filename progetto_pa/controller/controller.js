                    ...
                    if (item.length != 0) {
                        ...
                        */
                        model_1.Event.findAll({ where: { license_plate: license_plate }, raw: true })
                            ...
                            *--Se l'ultimo evento è di tipo "Enter" o "Inside" e il nuovo geofence_id e quella già presente corrispondono allora:
                            *si inserisce un nuovo evento "Enter" con la stessogeofence_id, mentre se non corrispondono si inseriscono due nuove righe:
