...
var Middleware_CoR = require("../middleware/middleware_CoR");
...
*/
app.post('/create-vehicle', Middleware_CoR.authentication, Middleware_CoR.create_vehicle, Middleware_CoR.catchError, function (req, res) {
    Controller.createVehicle(req.body, res);
});
/*
*Rotta per la creazione di una geofence area
*/
app.post('/create-geofence', Middleware_CoR.authentication, Middleware_CoR.create_geofence, Middleware_CoR.catchError, function (req, res) {
    Controller.createGeofence(req.body, res);
});
/*
*Rotta per associare una o più geo-fence areas ad uno o più veicoli
*/
app.post('/create-geofences_vehicles', Middleware_CoR.authentication, Middleware_CoR.create_geofences_vehicles, Middleware_CoR.catchError, function (req, res) {
...
*/
app.post('/delete-geofence_vehicle', Middleware_CoR.authentication, Middleware_CoR.delete_association, Middleware_CoR.catchError, function (req, res) {
...
*/
app.post('/show-associations', Middleware_CoR.authentication, Middleware_CoR.showAssociations, Middleware_CoR.catchError, function (req, res) { Controller.showAssociations(req, res); });
/*
*Rotta per inviare i dati instantanei di posizione, velocità e timestamp
*/
app.post('/send-position', Middleware_CoR.authentication, Middleware_CoR.sendPosition, Middleware_CoR.catchError, function (req, res, next) {
...
*/
app.get('/show-vehicles', function (req, res) { Controller.showVehicles(req, res); }); // no jwt
/*
*Rotta che consente di ritornare l’insieme delle posizioni di un veicolo in un dato intervallo temporale
*/
app.get('/show-position', Middleware_CoR.noAuthentication, Middleware_CoR.showPosition, Middleware_CoR.catchError, function (req, res) {
...
*/
app.post('/show-token', Middleware_CoR.authentication, Middleware_CoR.showToken, Middleware_CoR.catchError, function (req, res) {
    Controller.showToken(req.bearer.email, res);
});
/*
*Rotta che consente di ricaricare i token di un utente
*/
app.post('/refill', Middleware_CoR.authentication, Middleware_CoR.refill, Middleware_CoR.catchError, function (req, res) {
